...
# Check if composer2 is available
command -v composer2 >/dev/null 2>&1 || error_exit "Composer2 is not installed or not available in PATH."

# Install dependencies with Composer
echo "Installing dependencies..."
composer2 install --no-dev --prefer-dist --optimize-autoloader --no-interaction || error_exit "Composer install failed."
